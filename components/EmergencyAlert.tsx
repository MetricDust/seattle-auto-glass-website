  ...
  return (
    <div className="fixed top-24 left-0 right-0 z-40 pointer-events-none">
      <div className="container mx-auto px-4 flex justify-center">
        <div className="glass-panel-red pointer-events-auto rounded-full px-4 py-2 flex items-center justify-center space-x-3 animate-fade-in-down shadow-red-100">
