...
const testimonials = [
  ...
  },
  {
    ...
    role: "Fleet Manager",
    content:
      "We use Seattle Auto Glass for our entire delivery fleet. Their response time is incredible, and the pricing is very transparent. Highly recommended.",
    rating: 5,
  },
  {
    name: "Emily Chen",
          ...
          <div className="flex items-center justify-center space-x-2 mb-4">
            <div className="flex text-yellow-400">
              {[...Array(5)].map((_, i) => {
                ...
                return <Star key={i} className="w-6 h-6 fill-current" />;
              })}
            </div>
